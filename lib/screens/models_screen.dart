            ...
            children: [
              ListView(
                ...
                children: [
                  ...
                  ModelCard(
                    model: AIModel.llama32_1b,
                    isSelected: aiModelProvider.selectedModel?.id == AIModel.llama32_1b.id,
                    onTap: () => _selectModel(context, aiModelProvider, AIModel.llama32_1b),
                  ),
