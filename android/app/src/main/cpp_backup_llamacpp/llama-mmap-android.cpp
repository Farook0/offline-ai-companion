...
// Android NDK compatibility fix for posix_madvise
#ifdef ANDROID_POSIX_MADVISE_FIX
#include <sys/mman.h>  // Ensure madvise is declared
inline int posix_madvise(void *addr, size_t len, int advice) {
    // On Android, use madvise instead of posix_madvise
